# 历史记录：b405f2a 手册适配（已被替代）

下文保留当时的迁移判断，不是当前接口。提交6903096现保存在legacy-main，原生custom2、三对象STG和物理NTT布局
已取代下文的旧映射/两对象语法；使用 [当前同步说明](INLINE_MAIN_6903096.md) 与该commit内手册。

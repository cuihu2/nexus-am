...
`uint32_t` coefficients (16 KiB, 64 HPU lines).  Cases 08 and 09 additionally embed
...
all 4096 coefficients against immutable ELF data.  Cases 08 and 09 also recompute every

...
Before entering S-mode, the `riscv64-xs` AM startup now establishes an
...
SEIP.  It also disables the CTE timer so cases 04, 05, 07, and 08 cannot accept
a timer interrupt as an HPU completion.  This initialization order follows

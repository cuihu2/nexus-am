...
#define CASE_ID "HPU_IT_DIR_INS_C0_002"
#define TESTPOINT "IT-INS-C0-002"
#define DESCRIPTION "PSUB模减结果写回闭环"
#define TEST_MODE "定向指令闭环"
#define PRIORITY 0
#define CASE_KIND "HPU_CASE_INS_PSUB"
#define REQUIREMENTS "HPU_REQ_IT_MONITOR | HPU_REQ_CACHE_CONTRACT"
#define SEED UINT32_C(0xc002)
...
int main(void) {
    ...
    if (hpu_it_issue_dload(HPU_IT_P1, HPU_IT_LINE_SRC_B,
                           HPU_IT_POLY_LINES, HPU_IT_DMA_POLY) != 0)
        return 1;
    if (hpu_it_issue_arith(HPU_IT_ARITH_PSUB) != 0) return 1;
    ...
    if (hpu_it_compare_binary_output(HPU_IT_ARITH_PSUB,
                                     HPU_IT_LINE_OUT_A,

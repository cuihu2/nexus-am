...
#define CASE_ID "HPU_IT_DIR_CMB_002"
#define TESTPOINT "IT-CMB-002"
#define DESCRIPTION "完整NTT算子序列"
#define TEST_MODE "定向组合算子"
#define PRIORITY 1
#define CASE_KIND "HPU_CASE_CMB_NTT"
...
int main(void) {
     ...
     * 3. 因此本用例不写 HPU CSR、不发明完整 NTT 指令序列，也不产生假 self-check PASS。

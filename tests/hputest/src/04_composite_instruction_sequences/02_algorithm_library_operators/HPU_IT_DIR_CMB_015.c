...
#define CASE_ID "HPU_IT_DIR_CMB_015"
#define TESTPOINT "IT-CMB-015"
#define DESCRIPTION "Poseidon算法库bootstraping组合序列"
#define TEST_MODE "定向算法库算子"
#define PRIORITY 2
#define CASE_KIND "HPU_CASE_CMB_BOOTSTRAP"
...
int main(void) {
     ...
     * 3. 指令：不发出任何 HPU 命令；不能用其他算子冒充“执行 Poseidon bootstrapping 组合序列”。

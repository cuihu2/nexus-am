...
#define CASE_ID "HPU_IT_DIR_CMB_010"
#define TESTPOINT "IT-CMB-010"
#define DESCRIPTION "Poseidon算法库HMUL组合序列"
#define TEST_MODE "定向算法库算子"
#define PRIORITY 2
#define CASE_KIND "HPU_CASE_CMB_HMUL"
...
int main(void) {
     ...
     * 3. 因此本用例不写 HPU CSR、不发明 HMUL 指令序列，也不产生假 self-check PASS。

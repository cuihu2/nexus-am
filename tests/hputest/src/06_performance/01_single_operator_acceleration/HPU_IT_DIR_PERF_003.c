...
#define CASE_ID "HPU_IT_DIR_PERF_003"
#define TESTPOINT "IT-PERF-003"
#define DESCRIPTION "INTT算子加速比"
#define TEST_MODE "定向性能测试"
#define PRIORITY 3
#define CASE_KIND "HPU_CASE_PERF_INTT"
...
int main(void) {
     ...
     * 2. 完整 INTT 尚缺已解析的 DMA span/golden，性能计划也未冻结基线、重复次数和门限。
